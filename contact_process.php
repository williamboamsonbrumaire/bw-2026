...
$email_domaine_serveur = "hey@williamboamsonbrumaire.com"; // <-- REMPLACEZ CECI
$nom_site = "William Boamson Brumaire- Site Officiel"; // <-- REMPLACEZ CECI

// Adresse e-mail de destination (où vous recevrez le formulaire)
$destinataire = "williamboamsonbrumaire@gmail.com"; 
